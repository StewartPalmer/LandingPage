function _classCallCheck(n,t){if(!(n instanceof t))throw new TypeError("Cannot call a class as a function");}var animteHTML=function(){var n,t,i=function(){n=document.getElementsByClassName("featurelist_inner ");t=window.innerHeight;r()},r=function(){window.addEventListener("scroll",u);window.addEventListener("resize",i)},u=function(){for(var r,i=0;i<n.length;i++)r=n[i].getBoundingClientRect().top,r-t<=0&&(n[i].className=n[i].className.replace("element-hidden","slideInRight"))};return{init:i}},_createClass,getTime,Vel;animteHTML().init();
/*!
