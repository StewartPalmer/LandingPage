function ValidateEmail(n){return/^\w+([\.-]?\w+)*@\w+([\.-]?\w+)*(\.\w{2,3})+$/.test(n)?(validEmail=!0,!0):(validEmail=!1,!1)}function _classCallCheck(n,t){if(!(n instanceof t))throw new TypeError("Cannot call a class as a function");}var validEmail,_createClass,getTime,Vel;document.addEventListener("DOMContentLoaded",function(){document.getElementById("signup-form").addEventListener("submit",function(n){var u,t;n.preventDefault();var i=document.getElementById("js-Email").value,r=document.getElementById("js-Name").value,f=document.getElementById("b_91325").value;ValidateEmail(i)===!0&&f===""&&r!=null&&(u="?email="+i+"&name="+r,t=new XMLHttpRequest,t.responseType="json",t.onreadystatechange=function(){console.log(t.status);t.status===200&&(document.getElementById("result").innerText=t.responseText,console.log("Good Request"));t.status===400&&t.response!=null&&(document.getElementById("result").innerText=t.response.title==="Member Exists"?"You have already Subscribed":"An Error has Occured",console.log("Bad Request"))},t.open("POST","/SignUp/Subscribe"+u,!0),t.send())})});validEmail=!1;
/*!
